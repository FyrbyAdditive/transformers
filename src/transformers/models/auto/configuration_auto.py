...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("voxtral_streaming_encoder", "VoxtralStreamingEncoderConfig"),
        ("voxtral_streaming_text", "VoxtralStreamingTextConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("voxtral_streaming", "VoxtralStreaming"),
        ("voxtral_streaming_encoder", "VoxtralStreaming Encoder"),
        ("voxtral_streaming_text", "VoxtralStreaming Text Model"),
        ("wav2vec2", "Wav2Vec2"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict[str, str](
    [
        ...
        ("voxtral_streaming_encoder", "voxtral_streaming"),
        ("voxtral_streaming_text", "voxtral_streaming"),
